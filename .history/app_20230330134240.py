...
class Relatorios(FornecedoresFiltro):
    ...
    def clientesPositivados(self, data_inicial: str, data_final: str, vendedor: int):
        ...
        clientes_positivados = set(np.array(frame_filtrado['nome_fantasia']))
        print(clientes_positivados)
        for i in clientes_positivados:
            print(i)
...
if __name__ == '__main__':
    ...
    relatorio_geral.clientesPositivados('2022-06-01', '2022-06-30', 10)
