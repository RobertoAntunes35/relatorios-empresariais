...
class AnaliseGeralVendedores(foo.Excel):
    ...
    def positivacaoClientePorVendedor(self, clientesVendedor: pd.DataFrame) -> int:
        ...
        dados_vendedores = self.retornoDadosVendedores(vendedores_selecionados)
        
        print(dados_vendedores)

        # for vendedor in codigos_vendedores_selecionados:
