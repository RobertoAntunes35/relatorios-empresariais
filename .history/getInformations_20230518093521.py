...
class AnaliseGeralVendedores(foo.Excel):
        ...
        def clientesporDiaVisita():
            ...
            if self.datas:
                for nome_vendedor, codigo_vendedor in dados_vendedores.items():
                    ...
                    data_frame_final = self.frameClientesNaoPositivados(listaClientesNaoPositivados=clientes_dia_nao_positivados, listaClientes=lista_frame_clientes_nao_positivados, frame=dados)
                    ...
                    file_name = input(str('Digite o nome do arquivo para gerar o arquivo: '))
                    self.convertToExcel(data_frame_final, (file_name + '.xlsx'), sheet_name='Planilha1')

            return vendedor_final, clientes_dia_nao_positivados, data_frame_final
    ...
    def convertToExcel(self, file, fileName: str, sheetName: str):
        try:
            file.to_excel(fileName, sheet_name=sheetName)
        except:
            TypeError()
