...
class AnaliseGeralVendedores(foo.Excel):
        ...
        def clientesporDiaVisita():
            ...
            if self.datas:
                for nome_vendedor, codigo_vendedor in dados_vendedores.items():
                    ...
                    clientes_dia = {}
                    contagemGeral = 0
                    dias_de_visita = set(np.array(self.dados.loc[self.dados['nome_vendedor'] == nome_vendedor]['dia_visita']))
    ...
    def diasVisita(self, diasVisita, framePedidos,frameClientes, vendedor, contagemGeral, listaNaoPositivados):
