...
if __name__ == '__main__':
    ...
    faturamentoVendedor = relatorio_geral.faturamentoMensalVendedor(
        data_inicial=datas.get('JULHO')[0],
        data_final=datas.get('JULHO')[1],
        vendedor=vendedores.get('antonio_monis')
    )

    print(datas.get('MARCO'))
    print(vendedores.get('antonio_monis'))
