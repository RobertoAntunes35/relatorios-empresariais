...
file_perfect = [
    {
        ...
        "mes":"Janeiro",    
        "faturamento":36000.00,
        "positivacao":[
            {
            "clientesEmCadastro":200, # [(clientesEmCadastro, 200), (clientesPositivados, 50), (relacaoPositivacao, 0.25)]
            "clientesPositivados":50,
            "relacaoPositivacao":0.25
            }
        ],
        "maiorDiaVenda":"Segunda-Feira",
        "menorDiaVenda":"Sexta-Feira",
        "clientesPositivadosForaDiaVenda":50,
        "maioresFornecedores":[
            {
            "Refrix":5000.00, # [(Refrix, 5000.00), (Bellpar, 3000.00), (Pompeia, 2000.00)]
            "Bellpar":3000.00,
            "Pompéia":2000.00
            }
        ],
        "menoresFornecedores":[
            {
                "Askov":150.00, # [(Askov, 150.00), (Acquissima, 200.00), (Leonoff, 250.00)]
                "Acquissima":200.00,
                "Leonoff":250.00
            }
        ] 
