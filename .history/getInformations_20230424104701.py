        ...
        def clientesporDiaVisita():
            ...
            for nome_vendedor, codigo_vendedor in dados_vendedores.items():
                ...
                for dia in dias_de_visita:
                    quantidade_clientes_por_dia_visita = np.array(dados.loc[(dados['dia_visita'] == dia) & (dados['nome_vendedor'] == nome_vendedor), ['nome_fantasia', 'dia_visita']])
                    for i in quantidade_clientes_por_dia_visita[1]:
                        print(i)
