...
if __name__ == '__main__':
    ...
    faturamentoVendedor = relatorio_geral.faturamentoMensalVendedor(
        data_inicial=datas.get('JUNHO', 'Não Encontrado')[0],
        data_final=datas.get('JUNHO','Não Encontrado')[1],
    ...
    positivacaoVendedor = relatorio_geral.clientesPositivados('2022-06-01', '2022-06-30', 10)
    print(f'Faturamento: {faturamentoVendedor:.2f}')
