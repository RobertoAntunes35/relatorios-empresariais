...
print(frame_janeiro.loc[frame_janeiro['nome_produto'] == 'AGUA DE COCO NEW SUCO 200ML C/27 UN', ['nome_produto','quantidade_produto']])

print(frame_janeiro['nome_produto'].value_counts())
