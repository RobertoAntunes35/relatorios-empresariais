...
dict_produtos_quantidade = {}
for produto in produtos:
    quantidade_produto = sum(frame_janeiro.loc[frame_janeiro['nome_produto'] == produto]['quantidade_produto'])
    dict_produtos_quantidade[produto] = quantidade_produto


for i in dict_produtos_quantidade.items():
    print(i)
