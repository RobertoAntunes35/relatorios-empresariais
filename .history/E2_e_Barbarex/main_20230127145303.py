...
frame_dezembro = frame_geral.loc[(frame_geral['data_importacao'] > '01/12/2022') & (frame_geral['data_importacao'] < '01/01/2023'), ['quantidade','nome_produto','valor_total','data_importacao','codigo_vendedor']]
