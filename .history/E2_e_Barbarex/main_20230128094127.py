...
# df = pd.DataFrame.from_dict(dict_produtos_quantidade_janeiro, orient='index', columns=['Quantidade']).reset_index()
# print(df)
# sns.barplot(x='Quantidade', y='index', data=df)
# plt.show()
...
plt.plot(x, y)
plt.annotate('Ponto de máximo', xy=(3, 3), xytext=(4, 4),
