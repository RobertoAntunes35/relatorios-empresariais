...
class AnaliseGeralVendedores(foo.Excel):
    ...
    def positivacaoClientePorVendedor(self, clientesVendedor: pd.DataFrame) -> int:
        ...
        for vendedor, nome_vendedor in codigos_vendedores_selecionados, vendedores_selecionados:
            df_positivacao[nome_vendedor] = set(np.array(dados.loc[dados['codigo_vendedor'] == vendedor]['nome_fantasia']))
