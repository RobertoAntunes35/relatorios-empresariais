        ...
        def clientesporDiaVisita():
            ...
            for nome_vendedor, codigo_vendedor in dados_vendedores.items():
                ...
                for dia in dias_de_visita:
                    ...
                    print(f'Vendedor {nome_vendedor} dia {dia} quantidade {quantidade_clientes_por_dia_visita}')
                    print(dia, quantidade_clientes_por_dia_visita)
                # print(f'Vendedor {nome_vendedor} {clientes_dia}')
