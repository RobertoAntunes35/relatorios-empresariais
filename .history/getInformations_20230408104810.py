...
class AnaliseGeralVendedores(foo.Excel):
    ...
    def retornoDadosVendedores(self, listaInformacao: list):
        listaDados = []
        if isinstance(listaInformacao, (list, set)):
    ...
    def positivacaoClientePorVendedor(self, clientesVendedor: pd.DataFrame) -> int:
        ...
        vendedores_selecionados = set(np.array(dados['nome_vendedor']))
        vendedores_set = list(vendedores_selecionados)
        print(self.retornoDadosVendedores(vendedores_selecionados))
