            ...
            if self.datas:
                for nome_vendedor, codigo_vendedor in dados_vendedores.items():
                    ...
                    for i in clientes_dia_nao_positivados:
                        value_frame = dados.loc[dados['nome_fantasia'] == i, ['nome_vendedor', 'nome_fantasia', 'dia_visita', 'cidade']]
                        
                        lista_frame_clientes_nao_positivados.append(value_frame)               
                    dict_frame_clientes_nao_positivados[nome_vendedor] = lista_frame_clientes_nao_positivados

            return vendedor_final, clientes_dia_nao_positivados, pd.concat(dict_frame_clientes_nao_positivados.values())
