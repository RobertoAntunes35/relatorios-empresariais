...
class Relatorios(FornecedoresFiltro):
    ...
    def dadosFiltradosParaVendedores(self, data_inial: str, data_final: str, vendedor: int):
...
if __name__ == '__main__':
    ...
    print(relatorio_geral.faturamentoMensalVendedor('2022-06-01', '2022-06-30', 10))
