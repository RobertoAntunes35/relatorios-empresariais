...
for i in range(11):
    data = datetime.date(2023, i + 1, 1)
    first_day = data.replace(day=1)
    # print(first_Day)

    last_day = (datetime.date(data.year, data.month + 1, 1) - datetime.timedelta(days=1))
    print(type(last_day))
    print(f'first day {first_day.day} last day {last_day}')
