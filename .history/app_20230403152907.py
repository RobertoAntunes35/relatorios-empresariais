...
class AnaliseGeralVendedores(foo.Excel):
    ...
    def __init__(self, nome_arquivo: str, codigosVendedor: list, mes_analise: date, *teste, **columns_select) -> None:
        super().__init__(nome_arquivo, **columns_select)
    ...
    def codigoVendedor(self, newValue: int):
        if newValue in codigosVendedores.keys():
...
if __name__ == '__main__':
    ...
    Relatorio = AnaliseGeralVendedores(arquivo_pedido_itens, )
