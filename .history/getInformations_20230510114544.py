                    ...
                    for dia in dias_de_visita:
                        ...
                        for i in clientes_dia_visita:
                            if i not in clientes_vendedor:
                                ...
                                contagem +=1
                        clientes_dia[dia] = (quantidade_clientes_por_dia_visita,len(quantidade_clientes_por_dia_visita), contagem, round(contagem/len(quantidade_clientes_por_dia_visita), 3), clientes_dia_nao_positivados)
