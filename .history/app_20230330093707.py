...
class Relatorios(FornecedoresFiltro):
    ...
    def clientesPositivados(self, data_inicial: str, data_final: str, vendedor: int):
        ...
        frame_filtrado = dados.loc[(dados['codigo_vendedor'] == vendedor) & (dados['data_importacao'] >= data_inical) & (dados['data_importacao'] <= data_final)]
...
if __name__ == '__main__':
    ...
    relatorio_geral.clientesPositivados('01/06/2022', '31/06/2022', 10)
