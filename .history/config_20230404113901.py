...
ultimo_dia = data.replace(day=datetime.date(data.year, data.month+1, 1) - datetime.timedelta(days=1)).strftime('%Y-%m-%d')

print(f"Início do mês: {primeiro_dia}")
print(f"Fim do mês: {ultimo_dia}")
