...
from config import path, FILE_CLIENTES, FILE_PEDIDO_ITENS, FILE_STATIC
from config import vendedores
from fornecedores import analise_dados
...
class Clientes(foo.Excel):
    ...
    def filtroClientes(self):
        self.filter_frame().to_excel("ExcelQualimax.xlsx")
        self.filter_frame().plot.scatter(x='descricao_produto',y='total_volume')
        plt.show()
...
if __name__ == '__main__':
    ...
    Relatorio = AnaliseGeralVendedores(
        ...
        codigosVendedor=[11],
        inicio_mes_analise="2023-02-01",
        **rename_file_pedidoItens
    )
    
    rename_file_qualimax = {
        'Combinação22':'vendedor',
        'QUANT':'total_volume',
        'Texto28':'descricao_produto',
        'Vl_Prod':'total_faturado',
        'Texto66':'cidade',
        'Data_Importacao':'data',
        'Texto14':'nome_cliente',
        'CODCLI':'codigo_cliente',
        'Texto29':'codigo_produto',
    }    
